...
public class WebAuthorization {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/api/clients/current/accounts/{id}","/api/accounts/{id}","/api/cards/{id}","/api/clients/current/accounts", "/api/clients/current","/api/loans","/api/current/loans","/api/clients/current/cards","/accounts/transactions/pdf","/web/pages/payloans.html").hasAnyAuthority("CLIENT","ADMIN")
                .antMatchers(HttpMethod.POST,"/api/clients/current/accounts","/api/clients/current/cards","/api/clients/current/transactions", "/api/loans","/api/current/loans","/accounts/transactions/pdf","/web/pages/payloans.html" ).hasAnyAuthority("CLIENT", "ADMIN")
                .antMatchers("/web/js/**","/web/pages/**").hasAnyAuthority("CLIENT", "ADMIN")
                .antMatchers("/api/loans/manager","/admin/pages/**","/admin/css/**","/admin/js/**").hasAuthority("ADMIN")
